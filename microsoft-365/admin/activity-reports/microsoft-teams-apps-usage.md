...
Bu tabloda, her uygulama için aşağıdaki ölçümleri içeren uygulama başına görünüm gösterilir. Ölçüm sütunlarının bir alt kümesi varsayılan olarak eklenir ve sağ üst kısımdaki **Sütunları seç'e** tıklayarak sütun listesini seçebilir/düzenleyebilirsiniz.
...
|---|---|---|
|Uygulama Kimliği|Uygulama bildiriminde bulunan dış Uygulama tanımlayıcısı.|Evet|
|Son kullanılan tarih|Bu uygulamanın kuruluşunuzdaki herkes tarafından en son kullanıldığı tarih.|Evet|
|Bu uygulamayı kullanan ekipler|Bu uygulamayı kullanan en az bir kullanıcıya sahip olan ayrı Teams ekiplerinin sayısı.|Evet|
|Bu uygulamayı kullanan kullanıcılar|Kuruluşunuzda bu uygulamayı kullanan farklı kullanıcıların sayısı.|Evet|
|Windows'ta kullanılır| Bu, uygulamanın Kuruluşunuzdaki en az bir kullanıcı tarafından Windows'ta kullanılıp kullanılmadığını gösterir.|Evet|
|Mobil cihazlarda kullanılır|Bu, uygulamanın mobil cihazlarda kuruluşunuzdaki en az bir kullanıcı tarafından kullanılıp kullanılmadığını gösterir.|Evet|
|Web'de kullanılır| Bu, uygulamanın kuruluşunuzdaki en az bir kullanıcı tarafından Web'de kullanılıp kullanılmadığını gösterir.|Evet|
|Mac'te kullanılır|Kullanıcının belirtilen süre boyunca düzenlediği geçici toplantı sayısı.|Hayır|
|Uygulama adı|Uygulama bildiriminde mevcut olan bu uygulamanın adı.|Hayır|
|Publisher|Uygulama bildiriminde olduğu gibi bu uygulamanın yayımcısı. Bu yalnızca genel Mağaza'da yayımlanan uygulamalar için kullanılabilir.|Hayır|
...
**Kullanıcı etkinliği** sekmesini seçerek Teams uygulama kullanım raporunda **kullanıcı etkinliğini** görüntüleyebilirsiniz.
...
|Metrik|Tanım|Varsayılan olarak dahil mi?|
|---|---|---|
|Kullanıcı Adı|Benzersiz bir kullanıcının Kullanıcı adı. Değer varsayılan olarak gizlidir.|Evet|
|Yüklü uygulamalar|Kullanıcının yüklediği benzersiz uygulamaların (Mağaza ve özel) sayısı.|Evet|
|Kullanılan uygulamalar|Kullanıcının açtığı ve/veya kullandığı benzersiz uygulamaların (Mağaza ve özel) sayısı.|Evet|
|Ekipte kullanılan uygulamalar|Kullanıcının teams ekibinde açtığı ve/veya kullandığı benzersiz uygulamaların (Mağaza ve özel) sayısı.|Evet|
|Windows'ta kullanılır| Bu, kullanıcının Windows üzerinde herhangi bir uygulama kullanıp kullanmadığını gösterir.|Evet|
|Mobil cihazlarda kullanılır|Bu, kullanıcının Mobil (iOS veya Android) üzerinde herhangi bir uygulama kullanıp kullanmadığını gösterir.|Evet|
|Web'de kullanılır| Bu, kullanıcının Web'de herhangi bir uygulama kullanıp kullanmadığını gösterir.|Evet|
|Mac'te kullanılır|Bu, kullanıcının Mac'te herhangi bir uygulama kullanıp kullanmadığını gösterir.|Hayır|

...
|&nbsp;|**Seçenek 1 - Microsoft Teams Başlangıç** |**Seçenek 2 - Microsoft 365 İş Temel** |
|---|---|---|
|Kullanılabilir uygulamalar ve hizmetler|Yeni İş Standardı kayıt işlemini kullanarak mevcut e-posta hesabınızla (Hotmail, Gmail, Yahoo) oturum açın. OneDrive'da bulut depolama ile Microsoft Teams. Teams'de paylaşılan dosyaları düzenlemek için word, excel, powerpoint Office.com ücretsiz web sürümleri. <br/><br/> **Bu uygulama kümesi, görüntülü toplantılar ve sohbetler üzerinde etkili bir şekilde işbirliğine ihtiyacı olan çok küçük işletmeler için idealdir**. |Microsoft Teams ve OneDrive. Microsoft Exchange, SharePoint, Bookings, Planner ve Listeler. Office.com üzerinde Word, Excel, PowerPoint'in Premium Office web sürümleri. <br/><br/> **Microsoft 365 İş Temel ayrıca çok çeşitli web tabanlı hizmetlere erişmenizi sağlar**: <ul><li>Outlook ile yeni, markalı iş e-posta hesapları, işletmenizdeki paylaşılan takvimler.</li><li>Rezervasyonlar, randevu zamanlama ve Toplantı kayıtları.</li><li>Paylaşılan belge depolama alanı ve SharePoint siteleri.</li><li> Microsoft Planner ve Microsoft Listeler.</li></ul> <br/> Microsoft 365 İş Temel, Teams'de Etki Alanı Hesabı Kaydolma ile ek hizmetler sunar: <ul><li>Microsoft Teams'de toplantı kayıtları ve anonim arama erişimi.</li><li>İşletmenizde daha kolay belge paylaşımı.</li><li>Sektörünüz için uyumluluk gereksinimleri için destek.</li><li>Çalışanlarınızın hizmet kullanımına erişim ve denetim.</li><li>Teams ve Office'te çalışan Microsoft dışı uygulamaların (örneğin Salesforce, Adobe) en geniş tümleştirme yelpazesi.</li></ul>|
...
Zaten sahip olduğunuz bir etki alanını kullanmayı seçerseniz, Bu etki alanını Microsoft 365 ile e-posta adresiniz için kullanabilirsiniz. Kaydolma işleminin bir parçası olarak, güvenlik amacıyla etki alanını doğrulamanızı ve sahte etkinliklere karşı koruma sağlamanızı istiyoruz.

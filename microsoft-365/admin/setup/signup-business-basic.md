---
title: Microsoft 365 İş Temel için kaydolun
f1.keywords:
- NOCSH
ms.author: kwekua
author: kwekua
...
Microsoft 365 İş Temel aboneliği satın almak ve kaydolmak için aşağıdaki adımları tamamlayın.
...
1. [İş için sayfasında](https://go.microsoft.com/fwlink/?linkid=2181424) Microsoft 365'te neler olduğunu görün. Microsoft 365 İş Temel altında **Şimdi satın al'ı** seçin.
...
5. Microsoft 365'te nasıl oturum açabileceğinize karar verin. [Geçerli kişisel e-postanızla oturum açabilir veya etki alanı ekleyerek [yeni bir hesap oluşturabilirsiniz](setup-business-basic.md) .
...
Microsoft 365 İş Temel kaydolduğunda, kullanmaya başlamak için 2 seçeneğiniz vardır. Gereksinimlerinize en uygun olanı seçmek için üç önemli faktörü değerlendirin:
...
:::image type="content" source="../../media/sign-in-nia-contoso.png" alt-text="Ekran görüntüsü: Kişisel e-postanızla oturum açın.":::
...
2. Kuruluşunuz için kaç Microsoft 365 İş Temel lisansı istediğinizi seçin ve **Ödeme yöntemi ekle'yi** seçin ve **Sipariş ver'e** ödemeye devam edin.
...
Bu seçenekle, profesyonel, markalı e-posta sağlayıcınız olarak Microsoft 365 Exchange'i kullanabilirsiniz. Tüm kullanıcılarınızın paylaşılan bir etki alanı e-posta adresi olacaktır. Örneğin, kullanıcı adı ve ardından @contoso.com. Siz ve kullanıcılarınız bu yeni e-posta adresiyle Microsoft 365'de oturum açın. Bu işlemi uyguladığınızda (etki alanı ekleyin ve yeni iş e-posta hesapları oluşturun), Microsoft 365 İş Temel'de sağlanan tüm özelliklere erişebilirsiniz. Etki alanı satın alma veya ekleme adımları için bkz. [Microsoft 365 İş Temel ayarlama](../setup/setup-business-basic.md).
...
- [Ayarlamayı bitir](setup-business-basic.md#finish-setting-up)
...
**Şunlar için geçerlidir: Daha önce Basitleştirilmiş Kaydolma modunu kullanarak satın almış olan mevcut Microsoft 365 İş Temel aboneleri**.

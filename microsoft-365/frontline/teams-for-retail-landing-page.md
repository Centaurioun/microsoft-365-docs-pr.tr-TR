...
Yeni çalışanların önemli kaynaklar bulabileceği, kuruluşundaki kişilerle tanışabileceği ve yeni rollerinde başarılı olmaya hazırlanabileceği hepsi bir arada karma bir çalışma ortamı geliştirerek yeni çalışanın harika bir deneyime sahip olmasını sağlayın.
...
| ----- | ----- | ----- | ----- |
| Rezervasyon | Sanal bağlantı hatlarını ve danışmanlıkları etkinleştirin. | [Microsoft Teams ve Bookings uygulaması ile sanal randevular](bookings-virtual-visits.md) | [Bookings'i kullanma](https://support.microsoft.com/en-us/office/what-is-bookings-42d4e852-8e99-4d8f-9b70-d7fc93973cb5) |
| Power Apps ve Power Platform | İş süreçlerini tümleştirin ve mağaza envanteri, satış numaraları, olay raporları ve daha fazlası gibi verilerde hızlı güncelleştirmeler yapın. | [Microsoft Teams yönetim merkezinde Microsoft Power Platform ile Teams tümleştirmesi](/microsoftteams/platform/samples/teams-low-code-solutions) ve [Microsoft Power Platform uygulamalarını yönetme](/microsoftteams/manage-power-platform-apps) | -  |
| SharePoint | Yeni bir ekip oluşturduğunuzda, yeni bir SharePoint sitesi oluşturulur ve takıma bağlanır. Yukarıdaki senaryoların çoğu, ekip işbirliği için belgeleri paylaşma gibi Teams'e eklenmiş olan SharePoint özelliklerini kullanır. | [Teams ve SharePoint tümleştirmesi](/sharepoint/teams-connected-sites) | [Teams'te sekme olarak SharePoint sayfası, listesi veya belge kitaplığı ekleme](https://support.microsoft.com/office/add-a-sharepoint-page-list-or-document-library-as-a-tab-in-teams-131edef1-455f-4c67-a8ce-efa2ebf25f0b)|
| Viva Bağlantılar | Viva Bağlantılar Teams'de perakende iş ortaklarınızın kuruluşunuzdan uyarlanmış haber akışını ve ihtiyaç duydukları kaynakları içeren kişiselleştirilmiş bir panoyu görüntüleyebileceği bir merkez oluşturur. | [Viva Bağlantılar genel bakış](/sharepoint/viva-connections-overview) | [Microsoft Teams'de Viva Bağlantılar](https://support.microsoft.com/office/your-intranet-is-now-in-microsoft-teams-8b4e7f76-f305-49a9-b6d2-09378476f95b) |
| Viva Öğrenme | Gerektiğinde, çalışmalarının akışında eğitim sağlayın. | [Viva Öğrenme yönetme](/microsoft-365/learning/) | [Viva Öğrenme kullanma](https://support.microsoft.com/office/viva-learning-preview-01bfed12-c327-41e0-a68f-7fa527dcc98a) |
| Yammer | Yammer ile kuruluşunuzu bağlayın ve departmanlar ve bölgeler arasında iletişime izin verin. | [Yammer'i yönetme](/yammer) | [Yammer kullanma](https://support.microsoft.com/office/what-is-yammer-1b0f3b3e-89ee-4b66-aac5-30def12f287c) |

### <a name="retail-templates-for-teams"></a>Ekipler için perakende şablonları

Tek bir mağaza, bölge veya merkezinizle personeliniz arasında iletişim ve işbirliği için önceden yüklenmiş bir dizi ayar, kanal, sekme ve önceden yüklenmiş uygulama içeren ekipler oluşturun.

- Perakende **Düzenleme mağaza** şablonu Genel, Vardiya İletimi, Mağaza Hazırlığı ve Öğrenme kanallarını ve Onaylar, Görevler ve Wiki uygulamalarını içerir.
- **Yöneticiler için Perakende** şablonu Genel, İşlemler ve Öğrenme için kanallar içerir ve bir Wiki sekmesi içerir.

Mağazanızın ihtiyaç duyduğu uygulamaları dahil etmek için [özel bir şablon da oluşturabilirsiniz](/microsoftteams/create-a-team-template) . Daha fazla bilgi: [Perakende ekibi şablonlarını kullanmaya başlama](/microsoftteams/get-started-with-retail-teams-templates?bc=/microsoft-365/frontline/breadcrumb/toc.json&toc=/microsoft-365/frontline/toc.json)

## <a name="get-ready-to-roll-out-your-scenarios---identify-roles-and-responsibilities-for-scenarios"></a>Senaryolarınızı kullanıma sunma hazır olun- senaryoların rollerini ve sorumluluklarını belirleme

Hangi senaryoları uygulamak istediğinizi ve bunları desteklemek için nelere ihtiyacınız olduğunu bildiğinize göre, kuruluşunuzda nasıl çalıştıklarını planlamak, piyasaya çıkarmak ve izlemek için ekibinizi toplayabilirsiniz. Örneğin, kuruluşunuzda bu senaryoları kullanıma açmak için aşağıdaki roller gerekebilir:

| Görüntü | Rol | Sorumluluk | Bölüm |
| ---- | ---- | ----- | ----- |
|<img src="/office/media/icons/administrator.png" alt="Administrator symbol."> | BT Yöneticisi | Senaryoları ve bunların kuruluş için nasıl çalışılacağını tanımlamak için operasyon ve perakende yönetimi personeliyle çalışın. <br><br>Teams yönetim merkezinde ilkeler ve şablonlar gibi ayarları yapılandırın ve uygulamaları etkinleştirin. <br><br>Kuruluş için uygulama ayarlarını (genel Vardiya ayarları gibi) ayarlayın. <br><br>Kullanıcıları ekleme ve lisansla.  | BT departmanı |
|<img src="/office/media/icons/user-monitor.png" alt="User monitor symbol.">| Operasyon personeli | Senaryoları tanımlamak ve Teams için hangi ayarların, ilkelerin, şablonların ve uygulamaların gerekli olduğunu belirlemek için Yöneticilerle birlikte çalışın. <br><br>Şablonlardan bölgesel veya farklı ekipler oluşturun. <br><br>Bir bölgedeki mağazalar arasında veya mağazalarla genel merkez arasında koordinasyon için görevleri, listeleri ve onay akışlarını ayarlayın. <br><br>Personel için öğrenme çerçevesi ayarlayın. | Merkezi operasyonlar |
|<img src="/office/media/icons/presenter-teams.png" alt="Presenter symbol."> | Mağaza yöneticisi | Senaryoları tanımlamak için Yöneticiler ve operasyon personeliyle birlikte çalışın. <br><br>Şablonlardan mağaza için ekipler oluşturun. <br><br>Gerektiğinde ekipler için kanalları ve uygulamaları ayarlayın. Örneğin: Vardiya devretme işlemleri için bir kanal. <br><br>Vardiyalar'da mağaza zamanlamalarını ayarlama. <br><br>Mağazaya özgü görevleri, listeleri, güncelleştirmeleri ve onay akışlarını ayarlayın. <br><br>Personel için öğrenme görevlerini ayarlama. | Mağaza yönetimi |

...
4. Kullanıcı posta kutularında Gelen Kutusu klasöründeki **Fuze DataParser** adlı bir alt klasör oluşturulur ve Fuze öğeleri bu klasöre aktarılır. Bağlayıcı, *Email* özelliğinin değerini kullanarak öğelerin hangi posta kutusuna aktarılacağını belirler. Her Fuze öğesi, her katılımcının e-posta adresiyle doldurulan bu özelliği içerir.
...
1. <https://compliance.microsoft.com> Adresine gidin ve **Veri bağlayıcıları Veri Ayrıştırıcısı'nı** >  seçin.

2. **Fuze DataParser** ürün açıklaması sayfasında **Bağlayıcı ekle'yi** seçin.
...
2. **Bağlayıcılar** sekmesini seçin ve ardından bağlayıcının özelliklerini ve bilgilerini içeren açılır sayfayı görüntülemek için oluşturduğunuz Veri Ayrıştırıcı bağlayıcısını seçin.

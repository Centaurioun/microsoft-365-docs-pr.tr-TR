...
1. [https://compliance.microsoft.com](https://compliance.microsoft.com/) Adresine gidin ve **Veri bağlayıcıları** > **Webex Teams'i** seçin.

2. **Webex Teams** ürün açıklaması sayfasında **Bağlayıcı ekle'yi** seçin.
...
2. Açılan sayfayı görüntülemek için **Bağlayıcılar** sekmesini ve ardından **Webex Teams** bağlayıcısını seçin. Bu sayfa, bağlayıcı hakkındaki özellikleri ve bilgileri içerir.

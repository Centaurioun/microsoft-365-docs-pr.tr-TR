...
![Hizmet Güveni Portalı - Hizmet Güveni Portalı ana menüsü.](../media/86b754e1-c63c-4514-89ac-d014bf334140-2.png)
...
### <a name="certifications-regulations-and-standards"></a>Sertifikalar, Düzenlemeler ve Standartlar
...
- **ISO/IEC** - Uluslararası Standardizasyon Örgütü (ISO) / Uluslararası Elektroteknik Komisyonu (IEC)
- **SOC** - Sistem ve Kuruluş Denetimleri (SOC) 1, 2 ve 3 Raporları
- **GDPR** - Genel Veri Koruma Yönetmeliği
- **FedRAMP** - Federal Risk ve Yetkilendirme Yönetimi Programı
- **PCI** - Ödeme Kartı Sektörü (PCI) Veri Güvenliği Standartları (DSS)
- **CSA Star** - Cloud Security Alliance (CSA) Güvenlik, Güven ve Güvence Kayıt Defteri (STAR)
- **Avustralya IRAP** - Avustralya Bilgi Güvenliği Kayıtlı Assesor Programı (IRAP)
- **Singapur MTCS** - Çok Katmanlı Bulut Güvenliği (MTCS) Singapur Standardı
- **İspanya ENS** - İspanya Esquema Nacional de Seguridad (ENS)

### <a name="reports-whitepapers-and-artifacts"></a>Raporlar, Teknik İncelemeler ve Yapıtlar

Aşağıdaki kategorilerle ilgili genel belgeler:

- **BCP ve DR** - İş Sürekliliği ve Olağanüstü Durum Kurtarma
- **Kalem Testi ve Güvenlik Değerlendirmeleri** - Üçüncü taraflar tarafından gerçekleştirilen Sızma testlerinin ve güvenlik değerlendirmelerinin kanıtlaması
- **Gizlilik ve Veri Koruması** - Gizlilik ve Veri Koruma Kaynakları
- **SSS ve Teknik İncelemeler** - Sık sorulan soruların teknik incelemeleri ve yanıtları

### <a name="industry-and-regional-resources"></a>Sektör ve Bölgesel Kaynaklar

Aşağıdaki sektörler ve bölgeler için geçerli olan belgeler:

- **Finansal Hizmetler** - FSI için mevzuat uyumluluğu yönergelerini destekleyen kaynaklar (ülkeye göre)
- **Sağlık ve Yaşam Bilimleri** - Microsoft tarafından Sağlık Sektörü için sunulan özellikler
- **Medya ve Eğlence** - Medya ve Eğlence Sektörü Kaynakları
- **Birleşik Devletler Kamu** - Yalnızca ABD Kamu müşterilerine yönelik kaynaklar
- **Bölgesel Kaynaklar** - Microsoft'un çevrimiçi hizmetler çeşitli bölgesel ilkeler ve düzenlemelere uyumluluğunu açıklayan belgeler

### <a name="resources-for-your-organization"></a>Kuruluşunuz için kaynaklar

Kuruluşunuza uygulanan belgeler (kiracı tarafından kısıtlanır).

- **Kuruluşunuz için kaynaklar** - Kuruluşunuzun aboneliğini ve izinlerini temel alan belgeler

Seri onay işareti olan kaynaklar, belgenin birden çok sürümü olduğunu gösterir. Bu sürümler, belgeye tıkladıktan ve indirme sayfasında "tüm sürümleri görüntüle" seçeneğine tıklandığında görüntülenebilir.  

:::image type="content" source="../media/stp-series.png" alt-text="Belge serisi işaretlenir ve indirme sayfasında görüntülenebilir.":::

Tarihe ve bulut hizmetine göre filtreleme - Kullanılabilir belgeleri görüntülerken **, Tarihler'i** seçip kullanmak istediğiniz aralığı seçerek sonuçları tarih aralığına göre filtreleyebilirsiniz.
...
Belge indirme görünümü - Kullanılabilir belgeleri görüntülerken sonuçları ilgili **Bulut Hizmeti'ne** göre filtreleyebilirsiniz.
...
Bu bölümde tüm kullanılabilir belgeler görüntülenir. Kitaplığım bölümünüzde kaydedilecek belgeleri seçin. Belgeler Sertifikalar, Standartlar, Düzenlemeler ve Sektör Kaynakları altında gösterilen kategoriler altında sıralanır. Belirli bir bulut hizmetinin tüm kaynaklarını görüntülemek için **Bulut Hizmeti** filtresini kullanın.
...
:::image type="content" source="../media/stp-search.png" alt-text="Belgeleri arayın ve sonuçları filtreleyin.":::

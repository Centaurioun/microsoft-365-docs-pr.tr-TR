...
2. **Anlık Bloomberg** altındaki **Veri bağlayıcıları** sayfasında **Görüntüle'yi** seçin.

3. **Instant Bloomberg** ürün açıklaması sayfasında **Bağlayıcı ekle'yi** seçin
...
1. <https://compliance.microsoft.com> Adresine gidin ve **Veri bağlayıcıları** > **Anlık Bloomberg'i** seçin.

2. **Instant Bloomberg** ürün açıklaması sayfasında **Bağlayıcı ekle'yi** seçin

3. **Hizmet koşulları** sayfasında **Kabul Et'i** seçin.

4. **Bloomberg SFTP sitesi için kimlik bilgileri ekle** sayfasında, 3. Adım'ın altında aşağıdaki kutulara gerekli bilgileri girin ve **İleri'yi** seçin.
...
8. Yeni bağlayıcının içeri aktarma işleminin ilerleme durumunu görmek için **Veri bağlayıcıları** sayfasına gidin. Bağlayıcı hakkında bilgi içeren açılır sayfayı görüntülemek için bağlayıcıyı seçin.

...
> [!NOTE]
> **Kiracı veya kullanıcı geçersiz kılma nedeniyle teslim edilen Kimlik Avı'nı** ve müşteri geri bildirimlerine göre gelen **kutusuna/klasör varsayılan uyarı ilkelerine teslim edilen Kullanıcı kimliğine bürünme kimlik avı'nı** geçici olarak kaldırdık. Bunları geliştirmek için çalışıyoruz ve sonunda bunları yeni sürümlerle değiştireceğiz. O zamana kadar, aşağıdaki koşulları kullanarak işlevlerini değiştirmek için özel uyarı ilkeleri oluşturabilirsiniz:
>
> - **Etkinlik:** Teslim sırasında kimlik avı e-postası algılandı
> - **Posta ZAP değil**
> - **Posta yönü:** Gelen
> - **Posta teslim durumu:** Teslim edildi
> - **Algılama teknolojisi:**
>   - **Kiracı veya kullanıcı geçersiz kılma nedeniyle teslim edilen Kimlik Avı'nın çoğaltılması** için: Kötü amaçlı URL saklama, URL'yi patlatma, Gelişmiş kimlik avı filtresi, Genel kimlik avı filtresi, Etki alanı kimliğe bürünme, Kullanıcı kimliğine bürünme ve Marka kimliğe bürünme.
>   - **Gelen kutusuna/klasörüne teslim edilen Kullanıcı kimliğe bürünme kimlik avı çoğaltmak için**: Kullanıcı kimliğe bürünme
>
> Office 365'da kimlik avı önleme hakkında daha fazla bilgi için bkz. [Kimlik avı önleme ve kimlik avı önleme ilkelerini ayarlama](../security/office-365-security/set-up-anti-phishing-policies.md).

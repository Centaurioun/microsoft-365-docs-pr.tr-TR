...
### <a name="create-azure-app"></a>Azure uygulaması oluşturma
...
### <a name="set-azure-app-details-in-moodle"></a>Moodle'da Azure uygulama ayrıntılarını ayarlama
...
### <a name="configure-connection-between-microsoft-plugins-and-microsoft-services"></a>Microsoft eklentileri ile Microsoft hizmetleri arasındaki bağlantıyı yapılandırma
...
### <a name="configure-user-and-course-synchronization"></a>Kullanıcı ve kurs eşitlemesini yapılandırma

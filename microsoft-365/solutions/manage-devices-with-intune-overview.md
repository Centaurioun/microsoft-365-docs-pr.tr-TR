...
Öte yandan, ortamınız Microsoft Endpoint Configuration Manager de dahil olmak üzere ortak yönetim planları içeriyorsa, kuruluşunuz için en iyi yolu geliştirmek için [ortak yönetim belgelerine bakın](/mem/configmgr/comanage/). Ortamınız Windows 365 Bulut PC planları içeriyorsa, kuruluşunuz için en iyi yolu geliştirmek için [Windows 365 Enterprise belgelerine](/windows-365/enterprise/) bakın.

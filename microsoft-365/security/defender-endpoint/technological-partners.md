...
- [Görünürlük ve denetim elde etmek için uygulamaları bağlayın| Microsoft Docs](/defender-cloud-apps/enable-instant-visibility-protection-and-governance-actions-for-your-apps)
- [Uç Nokta için Microsoft Defender|Microsoft Docs iş ortağı uygulamaları](partner-applications.md)
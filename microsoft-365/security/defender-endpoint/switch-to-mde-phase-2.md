...
1. [Microsoft Defender Virüsten Koruma'yı uç noktalarınızda yeniden yükleyin/etkinleştirin](#reinstallenable-microsoft-defender-antivirus-on-your-endpoints).
...
|---|---|
|[Intune](/mem/intune/fundamentals/tutorial-walkthrough-endpoint-manager) <br/><br/> **NOT**: Intune artık Microsoft Endpoint Manager'nin bir parçasıdır.|1. [Microsoft Endpoint Manager yönetim merkezine](https://go.microsoft.com/fwlink/?linkid=2109431) gidin ve oturum açın.<br/><br/>2. **Cihazlar** \> **Yapılandırma profilleri'ni** seçin ve ardından yapılandırmak istediğiniz profil türünü seçin. Henüz bir **Cihaz kısıtlamaları** profil türü oluşturmadıysanız veya yeni bir tane oluşturmak istiyorsanız bkz. [Microsoft Intune'de cihaz kısıtlama ayarlarını yapılandırma](/intune/device-restrictions-configure).<br/><br/>3. **Özellikler'i** ve ardından **Yapılandırma ayarları: Düzenle'yi** seçin<br/><br/>4. **Virüsten koruma Microsoft Defender** genişletin.<br/><br/>5. **Bulut tabanlı korumayı** etkinleştirin.<br/><br/>6. **Kullanıcılara örnek göndermeden önce sor** açılan listesinde **Tüm örnekleri otomatik olarak gönder'i** seçin.<br/><br/>7. **İstenmeyebilecek uygulamaları algıla** açılan listesinde **Etkinleştir veya Denetle'yi** seçin.<br/><br/>8. **Gözden geçir + kaydet'i** ve ardından **Kaydet'i** seçin. <br/><br/> **İpucu**: Ayarlarını oluşturma ve yapılandırma da dahil olmak üzere Intune cihaz profilleri hakkında daha fazla bilgi için bkz. [Microsoft Intune cihaz profilleri nedir?](/intune/device-profiles).|
...
|Windows'da Denetim Masası|Buradaki yönergeleri izleyin: [Microsoft Defender Virüsten Koruma'yı açın](/mem/intune/user-help/turn-on-defender-windows). (Bazı Windows sürümlerinde *virüsten koruma* *Microsoft Defender yerine Windows Defender Virüsten Koruma* görebilirsiniz.)|
|[Gelişmiş grup ilkesi Yönetimi](/microsoft-desktop-optimization-pack/agpm/) <br/><br/> veya <br/><br/> [Grup İlkesi Yönetim Konsolu](/windows/security/threat-protection/microsoft-defender-antivirus/use-group-policy-microsoft-defender-antivirus)|1. **Bilgisayar yapılandırması** \> **Yönetim şablonları** \> **Virüsten Koruma Microsoft Defender** **Windows bileşenleri'ne** \> gidin.<br/><br/>2. **Virüsten Koruma Microsoft Defender kapat** adlı bir ilke arayın.<br/><br/>3. **İlke ayarını düzenle'yi** seçin ve ilkenin devre dışı bırakıldıkdan emin olun. Bu eylem virüsten koruma Microsoft Defender etkinleştirir. <br/>(Bazı Windows sürümlerinde *virüsten koruma* *Microsoft Defender yerine Windows Defender Virüsten Koruma* görebilirsiniz.)|

---
title: PowerShell API Kılavuzu ile Gelişmiş Tehdit Avcılığı
ms.reviewer: ''
...
- $appId: AAD uygulamanızın kimliği (uygulamanın Uç Nokta için Defender üzerinde 'Gelişmiş sorgu çalıştırma' izni olmalıdır)

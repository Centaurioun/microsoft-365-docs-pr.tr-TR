---
title: MachineActions API'sini listeleme
description: Uç Nokta için Microsoft Defender'da Makine Eylemleri koleksiyonunu almak için List MachineActions API'sini kullanmayı öğrenin.
keywords: api'ler, graf api'leri, desteklenen API'ler, machineaction koleksiyonu
...
ms.locfileid: "67523544"
---
# <a name="list-machineactions-api"></a>MachineActions API'sini listeleme
...
[Makine Eylemleri](machineaction.md) koleksiyonunu alır.

[OData V4 sorgularını](https://www.odata.org/documentation/) destekler.

OData'nın `$filter` sorgusu şu özelliklerde desteklenir: `id`, `status`, `machineId`, `type`, `requestor`, ve `creationDateTimeUtc` özellikleri.
...
Başarılı olursa, bu yöntem [machineAction](machineaction.md) varlıklarından oluşan bir koleksiyona sahip 200, Tamam yanıt kodunu döndürür.

## <a name="example-1"></a>Örnek 1

### <a name="example-1-request"></a>Örnek 1 istek

Burada, üç MachineActions içeren bir kuruluş üzerindeki isteğin bir örneği verilmiştir.
...
MachineActions'ı makine kimliğine göre filtreleyen ve en son iki MachineActions'ı gösteren bir istek örneği aşağıda verilmiştir.

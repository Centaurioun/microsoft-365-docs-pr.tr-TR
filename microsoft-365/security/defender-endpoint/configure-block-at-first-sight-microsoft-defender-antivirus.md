...
> [!TIP]
> Bu makale, kuruluşlar için güvenlik ayarlarını yöneten kuruluş yöneticilerine ve BT Uzmanlarına yöneliktir. Enteprise yöneticisi veya BT Uzmanı değilseniz ancak ilk bakışta engelleme hakkında sorularınız varsa [Kurumsal yönetici değil veya BT Uzmanı mı?](#not-an-enterprise-admin-or-it-pro) bölümüne bakın.
...
- [Bulut koruması](cloud-protection-microsoft-defender-antivirus.md);
...
> [!TIP]
> Microsoft Intune artık Microsoft Endpoint Manager'nin bir parçasıdır.
...
> [!TIP]
> Microsoft Endpoint Configuration Manager arıyorsanız, bu artık Microsoft Endpoint Manager'nin bir parçasıdır.

1. Microsoft Endpoint Manager()<https://endpoint.microsoft.com> içinde **Endpoint security** \> **Virüsten Koruma'ya** gidin.

2. Var olan bir ilkeyi seçin veya **Microsoft Defender Virüsten Koruma** profil türünü kullanarak yeni bir ilke oluşturun.
...
3. Aşağıdaki yapılandırma ayarlarını yapın veya onaylayın:
   ...
   - **Microsoft Defender Virüsten Koruma Saniyeler içinde Genişletilmiş Zaman Aşımı**: 50

   :::image type="content" source="images/endpointmgr-antivirus-cloudprotection.png" alt-text="Microsoft Endpoint Manager portalında ilk bakıştaki ayarları engelle" lightbox="images/endpointmgr-antivirus-cloudprotection.png":::
...
2. **grup ilkesi Yönetim Düzenleyicisi'ni** kullanarak **Bilgisayar yapılandırması** \> **Yönetim şablonları** \> **Windows Bileşenleri** \> **Microsoft Defender Virüsten Koruma** \> **MAPS'e** gidin.
...
2. **Virüs & tehdit koruması'nı** seçin ve ardından **Virüs & tehdit koruması ayarları'nın** altında **Ayarları Yönet'i** seçin.
...
> - Ayar Windows Ayarları'nda güncelleştirilmeden önce grup ilkesi Nesnesi aracılığıyla yapılan değişikliklerin tek tek uç noktalara dağıtılması gerekir.
...
5. Aşağıdaki ayarlardan birini veya daha fazlasını değiştirin:
   ...
   - **Microsoft Defender Virüsten Koruma Genişletilmiş Zaman Aşımı onay kutusunu saniyeler içinde** temizleyin.
...
## <a name="not-an-enterprise-admin-or-it-pro"></a>Kurumsal yönetici veya BT Uzmanı değil misiniz?

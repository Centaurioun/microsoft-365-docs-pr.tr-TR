...
search.appverid:
- MET150
description: Bu çözüm, Microsoft 365'te en yaygın siber güvenlik saldırılarının nasıl görünebileceğini ve bunlara nasıl yanıt verebileceğini bildirir
ms.custom:
- seo-marvel-apr2020
ms.subservice: mdo
...
Bu makale dizisi, Belirli bir saldırı türünün Microsoft 365'te nasıl görünebileceğini anlamanıza yardımcı olur ve yanıt vermek için izleyebileceğiniz adımlar sunar. Bunlar, şu noktaları anlamak için hızlı giriş noktalarıdır:

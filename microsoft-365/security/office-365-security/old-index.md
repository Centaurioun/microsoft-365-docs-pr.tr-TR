...
![Koruma ve Algılama'dan Araştırma ve Yanıtlama'ya kadar EOP ve Office 365 için Microsoft Defender ve bunların güvenlik vurgusu. Email Kimlik Doğrulaması yapılandırması (en azından DKIM ve DMARC) EOP ve kurulum için ayarlanmalıdır.](../../media/tp_EOPATPP1P2Take6.gif#lightbox)
...
Office 365 P2 için Microsoft Defender'da birincil arama aracına Gerçek zamanlı algılamalar yerine **Tehdit Gezgini** adı verilir. Bulut için Defender'a gittiğinizde Tehdit Gezgini'ni görürseniz Office 365 için Microsoft Defender P2'desiniz demektir.
...
[Office 365 için Microsoft Defender'de Saldırı Simülatörü kullanma](attack-simulator.md)

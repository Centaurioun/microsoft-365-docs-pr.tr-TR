...
|**HTML'de form etiketleri** <p> *MarkAsSpamFormTagsInHtml*|HTML etiketleri içeren `<form>` iletiler yüksek güvenilirlikli istenmeyen posta olarak işaretlenir. <p> Bu etiket web sitesi formları oluşturmak için kullanılır. Email reklamlar genellikle alıcıdan bilgi istemek için bu etiketi içerir.|`X-CustomSpam: Form tag in html`|

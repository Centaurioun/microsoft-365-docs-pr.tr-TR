...
> - Bu varlıkla (etki alanı veya e-posta adresi, URL, dosya) yeniden karşılaşıldığında, bu varlıkla ilişkili tüm filtreler atlanır. E-posta için diğer tüm varlıklar karar vermeden önce filtreleme sistemi tarafından değerlendirilmeye devam eder.
...
4. Görüntülenen **Analiz için Microsoft'a gönder** açılır öğesinde aşağıdaki bilgileri girin:
   ...
   - **URL**: Tam URL'yi (örneğin, `https://www.fabrikam.com/marketing.html`) girin ve görüntülenen kutudan seçin. Ayrıca bir üst düzey etki alanı (örneğin, `https://www.fabrikam.com/*`) sağlayabilir ve ardından görüntülenen kutudan bu etki alanını seçebilirsiniz. 

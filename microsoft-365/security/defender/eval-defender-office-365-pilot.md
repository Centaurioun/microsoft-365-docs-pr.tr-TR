...
5. İlke panosunda *Önceden belirlenmiş güvenlik ilkeleri'ne* tıklayın.
   ...
   :::image type="content" source="../../media/mdo-eval/7-mdo-eval-pilot-template-policies.png" alt-text="Tehdit ilkeleri türleri." lightbox="../../media/mdo-eval/7-mdo-eval-pilot-template-policies.png":::
...
8. Gerektiğinde belirli pilot kullanıcılara veya kullanıcı gruplarına temel ***MDO** _ korumaları uygulamak için koşullar ekleyin. Devam etmek için _Next* öğesine tıklayın.
   ...
   :::image type="content" source="../../media/mdo-eval/10-mdo-eval-pilot-mdo-protections.png" alt-text="İlkeler, Office 365 korumanın savunuldu olarak kabul edilir." lightbox="../../media/mdo-eval/10-mdo-eval-pilot-mdo-protections.png":::
...
|Kimlik sahtekarlığı önleme|Sahte zeka ve sahte zeka içgörüleri kullanarak kullanıcıları kimlik sahtekarlığına karşı koruyun.|[Office 365 için Defender'de kimlik sahtekarı zekasını yapılandırma](../office-365-security/learn-about-spoof-intelligence.md)|

...
| **İşlem dışlamaları** | İşlem dışlamaları, belirli işlemler tarafından açılan dosyaların Microsoft Defender Virüsten Koruma tarafından taranmasını engeller. [İşlem dışlamaları hakkında daha fazla bilgi edinin](../defender-endpoint/configure-process-opened-file-exclusions-microsoft-defender-antivirus.md). |

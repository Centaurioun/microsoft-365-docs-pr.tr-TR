...
| Öğe | Açıklama |
|:---|:---|
| **Giriş** | sizi Microsoft 365 Defender portalındaki giriş sayfanıza götürür. Giriş sayfasında, algılanan tüm etkin tehditlerin yanı sıra şirketinizin verilerinin ve cihazlarının güvenliğini sağlamaya yardımcı olacak öneriler vurgulanır. Güvenlik ekibinize zaman ve çaba kazandırmak için İş için Defender'a öneriler eklenir. Öneriler, endüstrinin en iyi deneyimlerini temel alır. Daha fazla bilgi için bkz[. Güvenlik önerileri - Microsoft Defender Güvenlik Açığı Yönetimi](../defender-endpoint/tvm-security-recommendation.md). |
| **Olaylar** | Sizi son olaylar listenize götürür. Uyarılar tetiklendiğinde olaylar oluşturulur. Bir olay birden çok uyarı içerebilir. Olaylarınızı düzenli olarak gözden geçirmeyi unutmayın. Daha fazla bilgi için bkz. [İş için Defender'da olayları görüntüleme ve yönetme](mdb-view-manage-incidents.md).|
| **Eylemler & gönderimleri** >  **İşlem merkezi** | Tamamlanan ve bekleyen eylemler de dahil olmak üzere yanıt eylemleri listenize götürür.<br/>- Devam etmek için onay gerektiren eylemleri görüntülemek için **Beklemede** sekmesini seçin.<br/>- Gerçekleştirilen eylemleri görmek için **Geçmiş** sekmesini seçin. Bazı eylemler otomatik olarak gerçekleştirilen; diğerleri el ile alınır veya onaylandıktan sonra tamamlanmıştır.<br/><br/>Daha fazla bilgi edinmek için [bkz. İşlem merkezindeki düzeltme eylemlerini gözden geçirme](mdb-review-remediation-actions.md). |
...
| **Tehdit analizi** | Sizi geçerli tehditlerin bir görünümüne götürür ve tehdit ortamınızın bir bakışta görünümünü sağlar. Tehdit analizi, Microsoft güvenlik araştırmacılarının raporlarını ve bilgilerini de içerir. Daha fazla bilgi edinmek için bkz. [Tehdit analizi aracılığıyla yeni ortaya çıkan tehditleri izleme ve yanıtlama](../defender-endpoint/threat-analytics.md). |
| **Güvenlik puanı** | Şirketinizin güvenlik konumunun bir gösterimini sağlar ve geliştirmek için öneriler sunar. Daha fazla bilgi edinmek için bkz. [Cihazlar için Microsoft Güvenli Puanı](../defender-endpoint/tvm-microsoft-secure-score-devices.md). |
...
| **Deneme** | Deneme aboneliği ekleyerek ek güvenlik ve uyumluluk özelliklerini deneyin. Gezinti çubuğunuzda **Denemeler'i** görmüyorsanız ve başka bir deneme sürümüne eklemek istiyorsanız, aşağıdaki adımlardan birini uygulayabilirsiniz: <br/>- [Küçük İşletme Çözümleri sayfasını](https://www.microsoft.com/en-us/store/b/business?icid=CNavBusinessStore) ziyaret edin ve **Sorular'ı seçin.** Deneme aboneliği ekleme konusunda yardım almak için bir uzmanla görüşün. <br/>- [Microsoft 365 yönetim merkezi](https://admin.microsoft.com/?auth_upn=admin%40M365B614031.onmicrosoft.com&source=applauncher#/catalog) gidin ve Faturalama **Satın Alma hizmetleri'ni** >  seçin. Yardıma ihtiyacınız varsa **Yardım & destek'i** seçin.    |
| **Varlık** >  **Aygıtları** | [Microsoft Intune](/mem/intune/fundamentals/what-is-intune) kayıtlı bilgisayarlar ve mobil cihazlar gibi cihazları görüntülemenizi sağlar. |
| **Bitiş noktası** >  **Güvenlik açığı yönetimi** | [Microsoft Defender Güvenlik Açığı Yönetimi](../defender-vulnerability-management/defender-vulnerability-management.md) özelliklerinize erişmenizi sağlar. Bir pano, öneriler, düzeltme etkinlikleri, yazılım envanteri ve şirketiniz içindeki olası zayıflıkların listesini sağlar. |
...
| **Gezinti bölmenizi özelleştirme** | Gezinti çubuğunuzdaki seçenekleri gizlemek veya görüntülemek için bu seçeneği belirleyin. |

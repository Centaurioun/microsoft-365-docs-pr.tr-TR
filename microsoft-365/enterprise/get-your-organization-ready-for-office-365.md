---
title: Microsoft 365 Kurumsal için planlama
ms.author: kvice
...
- Microsoft 365 kiracınız
  ...
  İnternet'e ağ bağlantılarınızı, Microsoft 365 kimliklerinizi planlamayı ve uygulamalar, şirket içi, Azure ve diğer öğelerle tümleştirmeyi içerir. Daha fazla bilgi [için Microsoft'un bulut teklifleri için Abonelikler, lisanslar, hesaplar ve kiracılar'a](subscriptions-licenses-accounts-and-tenants-for-microsoft-cloud-offerings.md) gidin.

- Müşterileriniz için destek

  Sertifika tabanlı kimlik doğrulaması, mobil cihaz yönetimi, kimlik doğrulama seçenekleri ve kiracılar arası işbirliğini içerir. Daha fazla bilgi için [Sertifika Tabanlı Kimlik Doğrulaması'na](microsoft-365-client-support-certificate-based-authentication.md) gidin.

- Karma modern kimlik doğrulaması desteği

  Temel Microsoft 365 üretkenlik uygulamalarının karma yapılandırmalarını kullanırken modern kimlik doğrulaması planlamasını içerir. Daha fazla bilgi için [Karma modern kimlik doğrulamasına genel bakış ve önkoşullar](hybrid-modern-auth-overview.md) bölümüne gidin.
